...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    // Retrieve data from route arguments if available
    data = data.isNotEmpty
        ? data
        : ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>;

    // Set background image and color based on isDaytime flag
        ...
        child: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/$bgImage'), // Correct asset path
              fit: BoxFit.cover,
            ),
          ),
          child: Padding(
